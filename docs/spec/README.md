...
adds pointer notes to §13 and §29, and ADR-0011 adds pointer notes to §5, §24,
§26, §34 and §46.4).
...
| 5 | Sliding window / buckets | `services/aggregator/window`, `core/time`, `docs/adr/0011` |
| 6, 7, 38 | HOT/COLD hysteresis | `core/state/machine.py` (the comparison), `services/aggregator/transitions.py` (emission), `docs/adr/0011` |
...
| 24, 25 | Out-of-order, bucket math | `services/aggregator/lateness.py`, `core/time/buckets.py`, `docs/adr/0002`, `docs/adr/0011` |
| 26 | Memory / retention | `services/aggregator/window/expiry.py`, `services/aggregator/window/store.py`, `docs/adr/0011` |
...
| 30, 39 | Per-observation algorithm (counter, evaluate, emit) | `services/aggregator/worker.py`, `services/aggregator/transitions.py`, `docs/adr/0011` |
| 32, 33 | Persistence & snapshots | `services/trie/snapshot` |
| 34 | Versioned configuration | `core/config`, `services/aggregator/reevaluate.py`, `docs/adr/0009`, `docs/adr/0011` |
...
| 46 | Per-IP attributes (weight, extensibility) | `core/attributes.py` (`threshold_ratio`, `build_attributes`), `services/trie/metadata/ip_attributes.py`, `services/aggregator/transitions.py`, `core/events`, `core/config`, `docs/adr/0005`, `docs/adr/0011` |
