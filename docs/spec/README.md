...
| 13, 14, 31 | Prefix classification & scoring | `services/detector`, `services/trie/query` (`GET /prefixes/hot`, `?minimal=true` for §31), `docs/adr/0017` (Amendment 4 rulings 2 and 5) |
