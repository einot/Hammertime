...
| 29 | Read path | `services/trie/query`, `services/detector/api.py`, `docs/protocol/read-api-v1.md`, `docs/adr/0010`, `docs/adr/0015` (Amendment 5: `request_count` on `GET /ip`), `docs/adr/0017` (decisions 9 and 15) |
