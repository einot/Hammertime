...
map, a `Mapping[Address, IpRecord]`, and the coupled single-writer step).
None of them imports this package, and nothing in `hammertime.trie.structure` imports any of them.
"""
